...
<html>
    ...
    <body class = "designfeedback">
        ...
        <?php else: ?>
            ...
            <div class ="post_password_required">
                <form action="<?php echo add_query_arg( 'action', 'postpass', wp_login_url() ); ?>" method="post">
                    <div class="text">This design is password protected.<br>To view it please enter your password below.</div>
                    <div class="subtext"><strong>Password:</strong> <input name="post_password" type="password"/></div>
                    <div><input class="continue" type="submit" value="Load Design"/></div>
                </form>
            </div>
        <?php endif; ?>
    </body>
